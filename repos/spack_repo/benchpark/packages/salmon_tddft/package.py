    ...
    def cmake_args(self):
        ...
        if self.compiler.name == 'fj':
            ...
            args += [
                ...
                self.define(
                    "CMAKE_Fortran_FLAGS", 
                    "-O3 -Wall -fstrict-aliasing -acc=strict -gpu=cc80,cc90,managed,ptxinfo -cudalib=cublas -cuda -Minfo=accel -DUSE_OPENACC",
                ),
                self.define(
                    "CMAKE_C_FLAGS", 
                    "-O3 -Wall -alias=ansi -acc=strict -gpu=cc80,cc90,managed,ptxinfo -cudalib=cublas -cuda -Minfo=accel -DUSE_OPENACC",
                ),
