Example procedure for setting up and running SAXPY on the Genoa environment of RCCS-Cloud.
---
...
To avoid repeatedly switching `venv` environments, it is recommended to use separate terminals for 'login1' and 'genoa'.
