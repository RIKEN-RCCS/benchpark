...
```bash
benchpark system init --dest=gh200 riken-gh200 compiler=nvhpc  ← デフォルトは nvhpc@26.3
benchpark system init --dest=gh200 riken-gh200 compiler=nvhpc nvhpc=25.9  ← nvhpc@25.9 に変更する
```
---
