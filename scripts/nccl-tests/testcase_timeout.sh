...
# +++ Sizes to scan(-i and -e) +++
    "min_bytes:1G:-b <min size in bytes> default 32M"
    #"min_bytes:8M,16M,32M:-b <min size in bytes> default 32M"
    "max_bytes:8G:-e <max size in bytes> default 32M"
    #"max_bytes:32M,64M,128M:-e <max size in bytes> default 32M"
    "step_inc:1G:-i <increment size> default 1M"
...
# +++ Test operation +++
    ...
    "timeout:1,10000:-T <time in seconds> default disabled"
)
